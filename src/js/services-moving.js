...
$('#economy-priceBtn').click(function (e){
    e.preventDefault()
    choseEconomyPrice()
})
$('#premium-priceBtn').click(function (e){
    e.preventDefault()
    chosePremiumPrice()
})
function chosePremiumPrice(){
    $('#economy-priceBtn').removeClass("active")
    $('#premium-priceBtn').addClass("active")
    $('#pricing_type').val('premium')
}
function choseEconomyPrice(){
    $('#economy-priceBtn').addClass("active")
    $('#premium-priceBtn').removeClass("active")
    $('#pricing_type').val('economy')
}
...
function disableAddressToInputs(isHide = false) {
    ...
    document.querySelector('.add_more_destination button').setAttribute('disabled', 'disabled');
    if (isHide) {
...
function undisableAddressToInputs() {
    ...
    document.querySelector('#addrCount-a').classList.remove('hide');
